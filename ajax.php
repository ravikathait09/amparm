...
{
	$userid=$_REQUEST['userdetail'];
	$userdetail=$user->findCustomRow(array('id'=>$userid));
	?>
                                       ...
                                       <div class="col-md-12">
                                         <div class="p10">
										  <div class="profile-avatar">
                                                <img class="center-block" src="<?php echo  $userdetail['profile_image_url'] ?>"  alt="<?php echo  $userdetail['screen_name'] ?>">
                                          </div>
										  </div> 
										</div>
                                        <div class="col-md-12">
											...
											<div class="twitter-widget-header bt p20">
                                                    <div class="col-lg-4 col-md-4 col-sm-4 text-center">
                                                        ...
                                                        <a href="#">
                                                            ...
                                                            <strong class="twitter-widget-number"><?php if($_SESSION['user_info']['tweetcount']<1000)echo $userdetail['tweetcount']; else echo round($userdetail['tweetcount']/1000,2).'K'  ?></strong> 
                                                        </a>
                                                    </div>
                                                    <!-- col-lg-4 end here -->
                                                    <div class="col-lg-4 col-lg-4 col-md-4 col-sm-4 text-center">
                                                        ...
                                                        <a href="#">
                                                            ...
                                                            <strong class="twitter-widget-number"><?php if($userdetail['friendcount']<1000)echo $userdetail['friendcount'] ;else echo  round($userdetail['friendcount']/1000,2).'K' ?></strong> 
                                                        </a>
                                                    </div>
                                                    <!-- col-lg-4 end here -->
                                                    <div class="col-lg-4 col-lg-4 col-md-4 col-sm-4 text-center">
                                                        ...
                                                        <a href="#">
                                                            ...
                                                            <strong class="twitter-widget-number"><?php if($userdetail['follower']<1000)echo $userdetail['follower']; else echo round($userdetail['follower']/1000,2).'K' ?></strong> 
                                                        </a>
                                                    </div>
                                                    <!-- col-lg-4 end here -->
                                                </div>
