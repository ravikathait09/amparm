...
class DB
{
	...
	*/
		...
		{
			$this->settings = include("settings.ini.php");                                                    
	...
	*/			
		...
		{                      
			...
			if ($statement === 'select' or $statement === 'show c') {
				return $this->sQuery->fetchAll($fetchmode);                                
			} 
			elseif ( $statement === 'alter ' || $statement === 'insert' ||  $statement === 'update' || $statement === 'delete' ) {
